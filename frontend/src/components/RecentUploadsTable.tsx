...
const RecentUploadsTable: React.FC<RecentUploadsTableProps> = ({ history, onViewAll }) => {
                ...
                <table className="w-full">
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                        {history.map((item) => {
                            ...
                            const showMoreCount = Math.max(0, item.receipt_ids.length - 10);
                                            ...
                                            <td colSpan={2} className="px-6 py-3 bg-gray-50">
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <div className="flex items-center gap-2 overflow-x-auto pb-1 scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100">
                                                        {item.receipt_ids.slice(0, 10).map((id, idx) => (
                                                            <span
                                                                key={idx}
