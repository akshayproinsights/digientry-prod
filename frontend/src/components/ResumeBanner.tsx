...
const ResumeBanner: React.FC<ResumeBannerProps> = ({
    ...
    if (status === 'no_uploads' || !lastDate || !lastReceiptNumber) {
        return null;
    }
                    ...
                    <p className="text-blue-900 text-sm">
                        {count > 1 ? (
                            <>
                                ...
                                <span className="font-semibold">{count} receipts</span> (Latest: #{lastReceiptNumber}).
                            </>
                        ) : (
                            <>
                                Last upload was for <span className="font-semibold">Receipt #{lastReceiptNumber}</span>{' '}
